...
public class FeatureService
{
    ...
    /**
     * @param onlyEnabled
     *            true, wenn nur die aktiven Features geladen werden sollen, sonst false
     * @param autorizationRequired
     *            true, wenn nur für den Benutzer autorisierte Features zurückgeliefert werden soll, sonst
     *            false
     * @return Alle im System verfügbaren Features wenn false, sonst nur die aktivierten. Darüber hinaus
     *         werden immer nur die Features zurückgegeben, für welche der Benutzter berechtigt ist.
     */
    ...
    private void registerFeatures(List<WebClientFeature> featuresToRegister)
    {
        ...
        for (WebClientFeature feature : featuresToRegister)
        {
            ...
            {
                logger.error("feature with name " + feature.getFeatureKey()
                        + " already existing. registration was skiped.");
            }
        }
    }
}

...
/**
 * Mapped die Eigenschaften einer der Persistenz bekannten Entität auf ein detachtes RemoteLogin oder
 * umgekehrt.
 * 
 * @author arndtmar
 */
...
public class RemoteLoginMapper
{
    ...
    public RemoteLoginDto mapToDto(RemoteLogin remoteLogin)
    {
        ...
        dto.setRemoteSystemPassword(remoteLogin.getRemoteSystemPassword());

        return dto;
    }

    /**
     * Wandelt eine Liste von attachten RemoteLogins in eine Liste von detachten RemoteLogins um.
     * 
     * @param remoteLogins
    ...
    /**
     * Wandelt eine Liste von detachten RemoteLogins in eine Liste von RemoteLogins Gruppen um.
     * 
     * @param dtos
